...
#--------------------—HIS Score-----------------
HIS <- read.csv("Indicator_dataset/HIS.csv")
...
# -------------------------------— Proteus Index -------------------------------
proteus <- read.csv("Indicator_dataset/proteus.csv")
...
#Load database
fewswb <- suppressMessages(read_csv("Indicator_dataset/FEWS February 2021 Update_04-05-21.csv", col_types = cols()))
...
#-------------------------—FAO/WFP HOTSPOTS----------------------------
fao_wfp <- suppressWarnings(read_csv("Indicator_dataset/WFP:FAO_food.csv", col_types = cols()) %>%
  dplyr::select(-X2))
...
# 
# #----------------—IMF Debt forecasts---------------------------------
# imfdebt <- read.csv("Indicator_dataset/imfdebt.csv")
# 
# imfdebt <- imfdebt %>%
#   mutate(Country = countrycode(Country,
#     origin = "country.name",
...
# #--—(OCHA)--
# # Load OCHA database
# ocha <- suppressMessages(read_csv("Indicator_dataset/OCHA_socioeconomic.csv"))
# ocha <- ocha %>%
#   dplyr::select(-X1) %>%
#   arrange(Country)
# 
...
inform_2021 <- suppressMessages(read_csv("Indicator_dataset/INFORM_2021.csv", col_types = cols()))
...
imf_un <- read.csv("Indicator_dataset/imf_unemployment.csv")
...
inform_2021 <- read.csv("Indicator_dataset/INFORM_2021.csv")
...
#-----------------------------—IDPs--------------------------------------------------------
idp_data <- read_csv("Indicator_dataset/population.csv",
                     col_types = cols(
