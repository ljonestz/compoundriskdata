...
#Load database
fewswb <- suppressMessages(read_csv("Indicator_dataset/FEWS February 2021 Update_04-05-21.csv"))
...
inform_2021 <- suppressMessages(read_csv("Indicator_dataset/INFORM_2021.csv"))
