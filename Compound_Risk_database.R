...
#Load database
fewswb <- suppressMessages(read_csv("https://raw.githubusercontent.com/ljonestz/compoundriskdata/master/Indicator_dataset/FEWS%20February%202021%20Update_04-05-21.csv", col_types = cols()))
